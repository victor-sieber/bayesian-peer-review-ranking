...
Finally, the reviewer--proposal assignment structure was used to study where
additional reviews could be most informative. Although different statistical
criteria preferred somewhat different individual assignments, a practical
comparison of small additional-review budgets found very little difference in
global uncertainty reduction between random allocation, targeting proposals
with high reviewer disagreement and model-based sequential allocation.

Overall, the results show how Bayesian ranking can complement transparent
evaluation rules by making ranking uncertainty explicit. They also suggest that
the value of targeted additional reviews depends on the purpose of the extra
evaluation: in the present CRS design, carefully optimizing a small number of
assignments offered little advantage for reducing global ranking uncertainty.
...
assignment would most reduce posterior uncertainty under V1 and compares A-,
...
constraints and compare the present greedy sequential rule with joint
...
proposals, such as cases with substantial reviewer disagreement or proposals
